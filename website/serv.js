...
app.get("/recv_data", (req, res) => {
    var new_data = {
        ...
        pm100_standard: req.query.pm100_standard,
        pm10_env: req.query.pm10_env,
        pm25_env: req.query.pm25_env,
        pm100_env: req.query.pm100_env,
        particles_03um: req.query.particles_03um,
        particles_05um: req.query.particles_05um,
        particles_10um: req.query.particles_10um,
        particles_25um: req.query.particles_25um,
        particles_50um: req.query.particles_50um,
        particles_100um: req.query.particles_100um
    }
